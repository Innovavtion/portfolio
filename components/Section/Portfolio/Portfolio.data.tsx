...
export const portfolioData: Array<portfolioProps> = [
  {
    name: "Kanban",
    description:
      "Приложение для управления развитием проектов, который помогает наглядно представлять задачи и добиться максимальной эффективности разработки.",
    stack: [
  ...
  },
  {
    name: "To-Do",
    description:
      "Приложение для планирования своих задач на день или больше. Был расширен базовый функционал списка задач, для большего удобства использования приложения.",
    stack: [
